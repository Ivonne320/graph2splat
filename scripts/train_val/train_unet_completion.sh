...
#SBATCH -J train_unet
#SBATCH -o logs/train_unet/train_unet%j.out
#SBATCH -e logs/train_unet/train_unet%j.err
...
export VLSG_TRAINING_OUT_DIR="/cluster/scratch/wangyih/overfitting_dataset/pretrained/training_unet_completion/2025-11-5_5_scenes_unet_fix_compressor_align_dino_test"
...
# Run training script
/cluster/home/wangyih/miniconda3/envs/graph2splat/bin/python src/trainval/train_unet_completion.py  --config scripts/train_val/train_structure.yaml --log_steps 1 output_dir=\"$VLSG_TRAINING_OUT_DIR\" ${args[@]}
