...
#SBATCH -J train_flow
#SBATCH -o logs/train_flow/train_flow%j.out
#SBATCH -e logs/train_flow/train_flow%j.err
...
export VLSG_TRAINING_OUT_DIR="/cluster/scratch/wangyih/overfitting_dataset/pretrained/training_structure_flow/2025-11-13_4scenes_flow_debug_no_padding"
...
# Run training script
/cluster/home/wangyih/miniconda3/envs/graph2splat/bin/python src/trainval/train_structure_models_flow.py   --config scripts/train_val/train_structure_vae_gt2gt.yaml --log_steps 1 output_dir=\"$VLSG_TRAINING_OUT_DIR\" ${args[@]}
