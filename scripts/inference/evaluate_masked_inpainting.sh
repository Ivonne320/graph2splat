...
# Run training script
/cluster/home/wangyih/miniconda3/envs/graph2splat/bin/python src/inference/masked_inpainting_evaluation.py --config scripts/train_val/train_structure.yaml --checkpoint /cluster/scratch/wangyih/overfitting_dataset/pretrained/training_masked_inpainting/2025-11-5_300_scenes_inpainting/snapshots/epoch-10.pth.tar --split=test --batch_size=16 
