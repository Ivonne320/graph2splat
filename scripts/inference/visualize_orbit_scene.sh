...
# Run training script
/cluster/home/wangyih/miniconda3/envs/graph2splat/bin/python src/inference/render_orbit_scene_gs.py --config scripts/train_val/train_batch_scene_gs.yaml --radius 1 --height 0.1 --scene_id fcf66d9e-622d-291c-84c2-bb23dfe31327  --snapshot /cluster/scratch/wangyih/overfitting_dataset/pretrained/debug_gs/batch/debug/20251218_summary_single_scene_resolution/128_reso_higher_lr/snapshots/epoch-870.pth.tar --output /cluster/scratch/wangyih/overfitting_dataset/pretrained/debug_gs/batch/debug/20251218_summary_single_scene_resolution/128_reso_higher_lr/vis_orbit --frame_ids 000004 --render_frame ${args[@]}
