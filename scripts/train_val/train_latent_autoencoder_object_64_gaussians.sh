...
#SBATCH -o logs/overfitting_scene_denser%j.out
#SBATCH -e logs/overfitting_scene_denser%j.err
...
export VLSG_TRAINING_OUT_DIR="$SCRATCH/training_scene_decoder/$timestamp"
...
# Run training script
/cluster/home/wangyih/miniconda3/envs/graph2splat/bin/python src/trainval/train_scene_decoder_modified.py --config scripts/train_val/train_latent_autoencoder_modified_num_gaussians_64.yaml --log_steps 1 output_dir=\"$VLSG_TRAINING_OUT_DIR\" ${args[@]}
