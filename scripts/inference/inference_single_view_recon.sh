...
/cluster/home/wangyih/miniconda3/envs/graph2splat/bin/python src/inference/slat_completion_inference.py --config scripts/train_val/train_structure.yaml \
    --unet_checkpoint /cluster/scratch/wangyih/overfitting_dataset/pretrained/training_unet_slat_completion/student/10scenes_compare/with_photo_otherview/snapshots/epoch-43.pth.tar \
    ...
    --scene_id 02b33dfb-be2b-2d54-92d2-cd012b2b3c40 --frame_id 000000 --student_pack_root /cluster/scratch/wangyih/3RScan --occ_threshold 0.5  \
    --max_latents 300000 --output_dir results/slat_infer_10_scenes-200teacher/
