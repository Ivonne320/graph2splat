...
export VLSG_TRAINING_OUT_DIR="$SCRATCH/debug_gs/single/20scenes-128-0323"
...
# Run training script
/cluster/home/wangyih/miniconda3/envs/graph2splat/bin/python src/trainval/train_scene_gs_single_image.py  --config scripts/train_val/train_batch_scene_gs_single.yaml --log_steps 1 output_dir=\"$VLSG_TRAINING_OUT_DIR\" ${args[@]}
