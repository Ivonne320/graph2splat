...
#SBATCH -J train_structure_model
#SBATCH -o logs/train_structure_model/train_structure_model%j.out
#SBATCH -e logs/train_structure_model/train_structure_model%j.err
...
export VLSG_TRAINING_OUT_DIR="/cluster/scratch/wangyih/overfitting_dataset/pretrained/training_structure_model/2025-11-5_20_scenes_no_agc_with_flow_decode_z"
...
# Run training script
/cluster/home/wangyih/miniconda3/envs/graph2splat/bin/python src/trainval/train_structure_models_bbox_head.py   --config scripts/train_val/train_structure.yaml --log_steps 1 output_dir=\"$VLSG_TRAINING_OUT_DIR\" ${args[@]}
