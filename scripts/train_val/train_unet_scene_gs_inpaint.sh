...
export VLSG_TRAINING_OUT_DIR="$SCRATCH/debug_gs/gs_inpaint_unet/single_scene_debug_larger_lr"
...
# Run training script
/cluster/home/wangyih/miniconda3/envs/graph2splat/bin/python src/trainval/train_scene_gs_unet.py --config scripts/train_val/train_unet_scene_gs_inpaint.yaml   --log_steps 1 output_dir=\"$VLSG_TRAINING_OUT_DIR\" ${args[@]}
