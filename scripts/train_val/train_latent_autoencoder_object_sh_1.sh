...
#SBATCH -o logs/overfitting_scene_sh_1%j.out
#SBATCH -e logs/overfitting_scene_sh_1%j.err
...
# Run training script
/cluster/home/wangyih/miniconda3/envs/graph2splat/bin/python src/trainval/train_scene_decoder_modified.py --config scripts/train_val/train_latent_autoencoder_modified_sh_1.yaml --log_steps 1 output_dir=\"$VLSG_TRAINING_OUT_DIR\" ${args[@]}
