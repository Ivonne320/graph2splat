...
/cluster/home/wangyih/miniconda3/envs/graph2splat/bin/python src/inference/slat_completion_inference.py --config scripts/train_val/train_structure.yaml \
    --unet_checkpoint /cluster/scratch/wangyih/overfitting_dataset/pretrained/training_unet_slat_completion/student/500scenes_use_obj_filter/snapshots/epoch-1.pth.tar \
