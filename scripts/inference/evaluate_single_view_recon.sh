...
/cluster/home/wangyih/miniconda3/envs/graph2splat/bin/python src/inference/slat_completion_inference.py --config scripts/train_val/train_structure.yaml \
    --unet_checkpoint /cluster/scratch/wangyih/overfitting_dataset/pretrained/training_unet_slat_completion/student/500scenes_use_obj_filter_with_gen_fix_4090/snapshots/epoch-1.pth.tar \
    ...
    --eval_split val --max_eval 10000 --student_pack_root /cluster/scratch/wangyih/3RScan  --scene_id 02b33dfb-be2b-2d54-92d2-cd012b2b3c40  --use_obj_id_filter --generalization --mc_passes 5
