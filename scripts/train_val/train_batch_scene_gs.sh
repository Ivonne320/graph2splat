...
export VLSG_TRAINING_OUT_DIR="$SCRATCH/debug_gs/10-random/test"
...
# Run training script
/cluster/home/wangyih/miniconda3/envs/graph2splat/bin/python src/trainval/train_scene_gs.py  --config scripts/train_val/train_batch_scene_gs.yaml --log_steps 1 output_dir=\"$VLSG_TRAINING_OUT_DIR\" ${args[@]}
