...
export VLSG_TRAINING_OUT_DIR="$SCRATCH/debug_gs/batch/debug/20251218_summary_single_scene_resolution/128_reso_colorskip"
...
# Run training script
/cluster/home/wangyih/miniconda3/envs/graph2splat/bin/python src/trainval/train_scene_gs_rgb_skip.py  --config scripts/train_val/train_batch_scene_gs.yaml --log_steps 1 output_dir=\"$VLSG_TRAINING_OUT_DIR\" ${args[@]}
