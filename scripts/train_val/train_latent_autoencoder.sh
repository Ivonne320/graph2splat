...
#SBATCH -J train_scene_decoder
#SBATCH -o logs/train_scene_decoder_whole_set/train_scene_decoder_scene_level%j.out
#SBATCH -e logs/train_scene_decoder_whole_set/train_scene_decoder_scene_level%j.err
...
export VLSG_TRAINING_OUT_DIR="$SCRATCH/debug_gs/overfitting_LPIPS"
...
# Run training script
/cluster/home/wangyih/miniconda3/envs/graph2splat/bin/python src/trainval/train_scene_decoder_modified.py --resume --config scripts/train_val/train_latent_autoencoder_modified.yaml  --log_steps 1 output_dir=\"$VLSG_TRAINING_OUT_DIR\" ${args[@]}
