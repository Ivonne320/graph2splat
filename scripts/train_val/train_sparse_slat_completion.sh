...
#SBATCH -J train_sparse
#SBATCH -o logs/train_sparse_debug/train_sparse%j.out
#SBATCH -e logs/train_sparse_debug/train_sparse%j.err
...
export VLSG_TRAINING_OUT_DIR="/cluster/scratch/wangyih/overfitting_dataset/pretrained/training_sparse_slat_completion/student/500scenes_use_obj_filter_with_gen_fix_4090"
...
# Run training script
/cluster/home/wangyih/miniconda3/envs/graph2splat/bin/python src/trainval/train_sparse_completion.py  --config scripts/train_val/train_structure_sparse.yaml --log_steps 1 output_dir=\"$VLSG_TRAINING_OUT_DIR\" ${args[@]}
